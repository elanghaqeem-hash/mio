...
export const StudioCopilotDock: React.FC<StudioCopilotDockProps> = ({ state, mode, onOpenCore }) => (
  <button type="button" onClick={onOpenCore} className="studio-copilot-dock group" aria-label={`Open Mio Core from ${mode}`}>
    ...
    <span className="min-w-0 text-left">
      ...
      <span className="block truncate text-xs text-slate-300">{mode} workspace active</span>
    </span>
