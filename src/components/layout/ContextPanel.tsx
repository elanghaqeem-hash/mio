...
import { FolderGit2, Activity, Cpu, ShieldCheck, Camera, Mic, HardDrive } from 'lucide-react';
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-4">
        ...
        <div className="bg-[#0d121d] p-3 rounded-xl border border-gray-800">
          ...
          <div className="space-y-1 text-[10px] text-gray-400">
            ...
            <div className="flex justify-between">
              <span>Isolation:</span>
              <span className="text-emerald-400">PROJECT/ SANDBOX</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#0d121d] p-3 rounded-xl border border-gray-800 space-y-2">
          ...
          <div className="space-y-1 text-[10px] text-gray-400">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-emerald-400">OFF (NO SILENT FEED)</span>
            </div>
          </div>
        </div>
      </div>
