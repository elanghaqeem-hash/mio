...
import { CREATIVE_STUDIOS, adjacentCreativeStudio, creativeStudioForDocumentKind, resolveCreativeShortcut, type CreativeStudioMode } from '../../creative/CreativeWorkspaceIntegration';
