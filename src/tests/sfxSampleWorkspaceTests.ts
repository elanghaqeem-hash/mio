...
export function runSFXSampleWorkspaceTests(){let passed=0;const total=10;const a:SFXSampleAsset={id:'a',name:'Impact',sampleRate:48000,channels:2,lengthSamples:96000};
...
assert.equal(effectiveSFXDuration(1,[late]),4);assert.equal(effectiveSFXDuration(6,[late]),6);passed++;return{passed,total};}
