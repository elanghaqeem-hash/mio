import { beginGraphicResize, deleteMotionKeyframe, graphicToMotionProject, moveMotionKeyframe, setMotionKeyframeInterpolation, updateGraphicResize, upsertMotionKeyframe } from '../creative/GraphicMotionWorkspace';
