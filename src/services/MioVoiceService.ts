...
export class MioVoiceService {
  ...
  test(locale = this.preferredLocale) {
    const samples: Record<string, string> = {
      ...
      'ja-JP': 'テスト、Mio V2です。よろしくお願いします。', 'ko-KR': '테스트, 미오 V2입니다. 반갑습니다.',
      'zh-CN': '测试，这是 Mio V2，很高兴认识你。', 'es-ES': 'Prueba, soy Mio V2. Encantada de conocerte.',
      'fr-FR': 'Test, je suis Mio V2. Enchantée.', 'de-DE': 'Test, ich bin Mio V2. Freut mich.',
      'pt-BR': 'Teste, eu sou a Mio V2. Prazer em conhecer você.', 'ar-SA': 'اختبار، أنا ميو V2، سعيدة بلقائك.',
      'hi-IN': 'टेस्ट, मैं Mio V2 हूँ। आपसे मिलकर खुशी हुई।',
    };
