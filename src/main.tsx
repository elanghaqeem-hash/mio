      ...
      return (
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{ color: '#ef4444', margin: '0 0 12px 0', fontSize: '18px' }}>
              MIO V2 — RECOVERY INTERFACE
            </h2>
            <p style={{ color: '#94a3b8', fontSize: '12px', margin: '0 0 16px 0' }}>
              An unexpected render anomaly was intercepted by the system safety boundary.
            </p>
            <pre style={{
              backgroundColor: '#07090e',
              padding: '12px',
