...
class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div style={{
          width: '100vw', height: '100vh', backgroundColor: '#07090e', color: '#00f0ff', fontFamily: 'monospace',
          ...
          <div style={{ maxWidth: '600px', backgroundColor: '#0d121d', border: '1px solid #ef4444', borderRadius: '12px', padding: '24px', boxShadow: '0 0 20px rgba(239, 68, 68, 0.3)' }}>
            ...
            <button onClick={() => window.location.reload()} style={{ marginTop: '16px', padding: '8px 16px', backgroundColor: '#00f0ff', color: '#000', border: 'none', borderRadius: '6px', fontWeight: 'bold', cursor: 'pointer' }}>
              RELOAD WORKSPACE
            </button>
          </div>
        </div>
