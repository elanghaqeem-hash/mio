...
export const PermissionModal: React.FC<PermissionModalProps> = ({ request, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-fade-in">
      <div className="bg-[#0b101b] border border-cyan-500/40 rounded-xl max-w-xl w-full p-6 shadow-2xl shadow-cyan-950/50">
        <div className="flex items-center gap-3 border-b border-gray-800 pb-4 mb-4">
          ...
          <div>
            <h3 className="text-lg font-bold text-white tracking-wide flex items-center gap-2">
              ...
              <span className="text-xs px-2 py-0.5 rounded bg-red-900/60 text-red-300 border border-red-500/30 font-mono">
                {request.permissionLevel}
              </span>
            </h3>
            <p className="text-xs text-gray-400">Human-In-The-Loop confirmation required before execution</p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-end gap-3 pt-2 border-t border-gray-800">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-800 hover:bg-gray-700 text-gray-300 text-sm font-medium transition cursor-pointer"
          >
            <XCircle size={16} />
            CANCEL
          </button>
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-cyan-950 border border-cyan-500/40 hover:bg-cyan-900/60 text-cyan-300 text-sm font-medium transition cursor-pointer"
          >
            <Eye size={16} />
            REVIEW
          </button>
          <button
            ...
            className="flex items-center gap-2 px-5 py-2 rounded-lg bg-cyan-500 hover:bg-cyan-400 text-black font-bold text-sm shadow-lg shadow-cyan-500/30 transition cursor-pointer"
          >
            <CheckCircle size={16} />
            APPROVE
          </button>
