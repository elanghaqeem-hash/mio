...
import { AlertTriangle, ExternalLink, FileText, Globe2, Search } from 'lucide-react';
      ...
      <div className="flex-1 overflow-y-auto space-y-3">
        ...
        {!report && !isSearching && (
          <div className="h-full flex items-center justify-center text-gray-600 text-center">
            Research results will appear here with source reliability, epistemic status, conflicts, and citations.
          </div>
        )}
      </div>
    </div>
