...
export const MusicStudioView: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const scheduler=window.setInterval(()=>{
      ...
      for(const track of audibleMusicTracks(project.tracks)) scheduleAutomationSegments(track,first,last,transportOrigin+first*stepDuration);
