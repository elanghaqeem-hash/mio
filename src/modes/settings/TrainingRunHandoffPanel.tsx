...
} from '../../training/TrainingRunHandoffService';
  ...
  return (
    <div className="bg-[#0d121d] p-4 rounded-xl border border-gray-800 space-y-4">
      <div className="flex items-center gap-2 text-gray-300 font-bold">
        <Import size={14} className="text-cyan-400" /> GOVERNED TRAINING RUN HANDOFF
      </div>
      <p className="text-[10px] leading-relaxed text-gray-500">
        Import one <code>mio-training-handoff.json</code> produced from the governed TP-0.46 bundle + runner result. Mio verifies bundle, result binding, and handoff fingerprints before registration. The handoff never proves adapter bytes and never promotes or activates a model.
      </p>
