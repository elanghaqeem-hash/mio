  ...
  return (
    <div className="bg-[#0d121d] p-4 rounded-xl border border-gray-800 space-y-3">
      ...
      <p className="text-gray-500 text-[10px] leading-relaxed">
        Training results enter MIO as EXPERIMENTAL candidates. A candidate can become RELEASE_CANDIDATE only after an identity-matched MioBench policy pass plus explicit data-governance and security attestations. This panel never promotes or activates a model.
      </p>
      ...
      {selected && (
        <div className="rounded-lg border border-violet-500/30 bg-violet-950/10 p-3 space-y-3">
          ...
          <label className="flex items-start gap-2 rounded border border-gray-800 bg-[#111726] p-2.5 cursor-pointer">
            ...
            <span className="text-[10px] text-gray-300"><strong>Data-governance review completed.</strong> Dataset provenance, privacy/copyright eligibility, bundle fingerprints, and training-result binding have been reviewed.</span>
          </label>
          <label className="flex items-start gap-2 rounded border border-gray-800 bg-[#111726] p-2.5 cursor-pointer">
            ...
            <span className="text-[10px] text-gray-300"><strong>Security review completed.</strong> Model/tool boundaries, benchmark identity, safety regressions, and candidate artifact scope have been reviewed.</span>
          </label>
